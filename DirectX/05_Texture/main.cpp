...
struct CUSTOMVECTEX
{
	...
	float	tu, tv; // 텍스쳐 좌표계 x,y,와 같은 개념 , 0과 1로 정규화!!
#endif
};
...
#else
#define D3DFVF_CUSTOMVERTEX (D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX1) //텍스쳐좌표계
//텓스터 8개정도 있음 , tex1 ,2,.... 있음
#endif
...
void Render()
{
	...
	if (SUCCEEDED(g_pD3DDevice->BeginScene()))
	{
		...
		g_pD3DDevice->SetTextureStageState(0, D3DTSS_COLORARG2, D3DTA_DIFFUSE); // 섞겠다.
		g_pD3DDevice->SetTextureStageState(0, D3DTSS_ALPHAOP, D3DTOP_DISABLE); // 알파는 그대로
