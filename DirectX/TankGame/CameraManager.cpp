...
D3DXMATRIXA16*	CameraManager::SetView(D3DXVECTOR3* pvEye, D3DXVECTOR3* pvLookat, D3DXVECTOR3* pvUp)
{
	m_vEye = *pvEye;
	m_vLookat = *pvLookat;
	m_vUp = *pvUp;
...
D3DXMATRIXA16* CameraManager::RotateLocalX(float angle)
{
...
D3DXMATRIXA16* CameraManager::RotateLocalY(float angle)
{
	D3DXMATRIXA16 matRot;
...
D3DXMATRIXA16* CameraManager::MoveLocalX(float dist)
{
...
D3DXMATRIXA16* CameraManager::MoveLocalY(float dist)
{
	D3DXVECTOR3 vNewEye = m_vEye;
	D3DXVECTOR3 vNewDst = m_vLookat;
...
D3DXMATRIXA16* CameraManager::MoveLocalZ(float dist)
{
	D3DXVECTOR3 vNewEye = m_vEye;
	D3DXVECTOR3 vNewDst = m_vLookat;
...
D3DXMATRIXA16* CameraManager::MoveTo(D3DXVECTOR3* pv)
{
